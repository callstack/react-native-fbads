...
export default (Component) => class NativeAdWrapper extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.state.mediaViewNodeHandle !== -1 ||
            ...
            if (mediaViewNodeHandleChanged ||
                ...
                AdsManager.registerViewsForInteractionAsync(findNodeHandle(this.nativeAdViewRef), this.state.mediaViewNodeHandle, this.state.adIconViewNodeHandle, [...this.state.clickableChildren]);
            }
        }
    }
    /**
    ...
    render() {
        const _a = this.props, { adsManager } = _a, rest = __rest(_a, ["adsManager"]);
